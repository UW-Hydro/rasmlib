...
figp=/raid/muxiao/rasmfig/post_Nov_29/cru/   # output figure path
...
rasmfn3=era-interim.surface_moisture.        #1990-1999-01.monthly.mean.nc
rasmfn1=r33RBVIC60.vic.ha.
rasmfn2=r33RBVIC70.vic.ha.
erafn=cru_ts_3_10_01.pre.
nameend=.mean.nc


ses=DJFJJAMAMSON
i=1
while [ $i -lt 5 ] #   5 ]      # change to 4 seasons
do
let "sp=0+(i-1)*3"
let "ep=3" 
sea=$echo${ses:$sp:$ep}
...
python ./plot_mosi_cru/plot_cru.py --r1 $way1 --r2 $way2 --r3 $way3 --era $waye --figpath $figp --time $sea
echo $sea
let "i=$i+1"
done
...
python ./plot_mosi_cru/plot_cru.py --r1 $way1 --r2 $way2 --r3 $way3 --era $waye --figpath $figp --time $year
echo $year
...
for i in $echo {01..12}  # change to 12 months
do
mon=$i
mid1=1990-1999-
mid2=.monthly
...
echo $way1
echo $waye
python ./plot_mosi_cru/plot_cru.py --r1 $way1 --r2 $way2 --r3 $way3 --era $waye --figpath $figp --time $mon
echo $mon
...
python ./plot_mosi_cru/plot_cru.py --r1 $way1 --r2 $way2 --r3 $way3 --era $waye --figpath $figp --time $mid
echo $mid
