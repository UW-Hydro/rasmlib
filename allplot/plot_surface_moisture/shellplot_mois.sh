...
erafn=era-interim.surface_moisture.
nameend=.mean.nc
...
python ./plot_surface_moisture/plot_mois.py --r1 $way1 --r2 $way2 --r3 $way3 --era $waye --figpath $figp --time $sea
echo $sea
let "i=$i+1"
done
...
python ./plot_surface_moisture/plot_mois.py --r1 $way1 --r2 $way2 --r3 $way3 --era $waye --figpath $figp --time $year
echo $year
...
echo $way1
echo $waye
python ./plot_surface_moisture/plot_mois.py --r1 $way1 --r2 $way2 --r3 $way3 --era $waye --figpath $figp --time $mon
echo $mon
...
python ./plot_surface_moisture/plot_mois.py --r1 $way1 --r2 $way2 --r3 $way3 --era $waye --figpath $figp --time $mid
echo $mid
